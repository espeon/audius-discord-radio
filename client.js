...
const { token, token1, token2, prefix, ytkey, sckey } = process.env;
...
global.radio = new Map();
global.radioSelect = 0

global.radio.set(0, {'title': 'Audius Exclusives', 'links' :['https://audius.co/audius/playlist/official-audius-exclusives-1428']})
global.radio.set(1, {'title': 'phuture assortments', 'links' :['https://audius.co/phuture/playlist/assortments-vol.1-chill-bass-edm-trap-lo-fi-future-beats-3214']})
global.radio.set(2, {'title': 'Community Playlist', 'links' :['https://audius.co/audius/playlist/discord-community-playlist-vol.-1-3942']})
